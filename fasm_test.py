...
def check_round_trip(test, result):
    ...
    test.assertEqual(fasm.parse_fasm_string(s), result)

class TestFasm(unittest.TestCase):
    def test_blank_file(self):
        result = fasm.parse_fasm_filename('fasm_blank.fasm')
        self.assertEqual(result, [])

        check_round_trip(self, result)

    def test_comment_file(self):
        result = fasm.parse_fasm_filename('fasm_comment.fasm')
    ...
    def test_one_line_feature(self):
        result = fasm.parse_fasm_filename('fasm_feature_only.fasm')
        self.assertEqual(result, [fasm.FasmLine(
    ...
    def test_examples_file(self):
        result = fasm.parse_fasm_filename('fasm_examples.fasm')
        check_round_trip(self, result)
